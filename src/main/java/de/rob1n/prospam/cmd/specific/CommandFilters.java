...
public class CommandFilters extends Command implements CommandWithGui
{
    ...
    public void showGui(Player player)
    {
        ...
        {
            items.add(new Item(0, new ItemStack(Material.GREEN_STAINED_GLASS_PANE, 1, DyeColor.GREEN.getDyeData()), "Caps filter", "Click to disable", new Item.ClickAction()
            {
                @Override
        ...
        {
            items.add(new Item(0, new ItemStack(Material.RED_STAINED_GLASS_PANE, 1, DyeColor.RED.getDyeData()), "Caps filter", "Click to enable", new Item.ClickAction()
            {
                @Override
                public void onClick(Player player)
                {
        ...
        {
            items.add(new Item(1, new ItemStack(Material.GREEN_STAINED_GLASS_PANE, 1, DyeColor.GREEN.getDyeData()), "Chars filter", "Click to disable", new Item.ClickAction()
            {
                @Override
                public void onClick(Player player)
                {
        ...
        {
            items.add(new Item(1, new ItemStack(Material.RED_STAINED_GLASS_PANE, 1, DyeColor.RED.getDyeData()), "Chars filter", "Click to enable", new Item.ClickAction()
            {
                @Override
                public void onClick(Player player)
                {
        ...
        {
            items.add(new Item(3, new ItemStack(Material.GREEN_STAINED_GLASS_PANE, 1, DyeColor.GREEN.getDyeData()), "Flood filter", "Click to disable", new Item.ClickAction()
            {
                @Override
                public void onClick(Player player)
                {
        ...
        {
            items.add(new Item(3, new ItemStack(Material.RED_STAINED_GLASS_PANE, 1, DyeColor.RED.getDyeData()), "Flood filter", "Click to enable", new Item.ClickAction()
            {
                @Override
                public void onClick(Player player)
                {
        ...
        {
            items.add(new Item(4, new ItemStack(Material.GREEN_STAINED_GLASS_PANE, 1, DyeColor.GREEN.getDyeData()), "Similar filter", "Click to disable", new Item.ClickAction()
            {
                @Override
                public void onClick(Player player)
                {
        ...
        {
            items.add(new Item(4, new ItemStack(Material.RED_STAINED_GLASS_PANE, 1, DyeColor.RED.getDyeData()), "Similar filter", "Click to enable", new Item.ClickAction()
            {
                @Override
                public void onClick(Player player)
                {
        ...
        {
            items.add(new Item(7, new ItemStack(Material.GREEN_STAINED_GLASS_PANE, 1, DyeColor.GREEN.getDyeData()), "URL filter", "Click to disable", new Item.ClickAction()
            {
                @Override
                public void onClick(Player player)
                {
        ...
        {
            items.add(new Item(7, new ItemStack(Material.RED_STAINED_GLASS_PANE, 1, DyeColor.RED.getDyeData()), "URL filter", "Click to enable", new Item.ClickAction()
            {
                @Override
                public void onClick(Player player)
                {
        ...
        {
            items.add(new Item(8, new ItemStack(Material.GREEN_STAINED_GLASS_PANE, 1, DyeColor.GREEN.getDyeData()), "Blacklist filter", "Click to disable", new Item.ClickAction()
            {
                @Override
                public void onClick(Player player)
                {
        ...
        {
            items.add(new Item(8, new ItemStack(Material.RED_STAINED_GLASS_PANE, 1, DyeColor.RED.getDyeData()), "Blacklist filter", "Click to enable", new Item.ClickAction()
            {
                @Override
                public void onClick(Player player)
                {
        ...
        {
            items.add(new Item(18, new ItemStack(Material.GREEN_STAINED_GLASS_PANE, 1, DyeColor.GREEN.getDyeData()), "Caps actions", "Click to disable", new Item.ClickAction()
            {
                @Override
                public void onClick(Player player)
                {
        ...
        {
            items.add(new Item(18, new ItemStack(Material.RED_STAINED_GLASS_PANE, 1, DyeColor.RED.getDyeData()), "Caps actions", "Click to enable", new Item.ClickAction()
            {
                @Override
                public void onClick(Player player)
                {
        ...
        {
            items.add(new Item(19, new ItemStack(Material.GREEN_STAINED_GLASS_PANE, 1, DyeColor.GREEN.getDyeData()), "Chars actions", "Click to disable", new Item.ClickAction()
            {
                @Override
                public void onClick(Player player)
                {
        ...
        {
            items.add(new Item(19, new ItemStack(Material.RED_STAINED_GLASS_PANE, 1, DyeColor.RED.getDyeData()), "Chars actions", "Click to enable", new Item.ClickAction()
            {
                @Override
                public void onClick(Player player)
                {
        ...
        {
            items.add(new Item(21, new ItemStack(Material.GREEN_STAINED_GLASS_PANE, 1, DyeColor.GREEN.getDyeData()), "Flood actions", "Click to disable", new Item.ClickAction()
            {
                @Override
                public void onClick(Player player)
                {
        ...
        {
            items.add(new Item(21, new ItemStack(Material.RED_STAINED_GLASS_PANE, 1, DyeColor.RED.getDyeData()), "Flood actions", "Click to enable", new Item.ClickAction()
            {
                @Override
                public void onClick(Player player)
                {
        ...
        {
            items.add(new Item(22, new ItemStack(Material.GREEN_STAINED_GLASS_PANE, 1, DyeColor.GREEN.getDyeData()), "Similar txt actions", "Click to disable", new Item.ClickAction()
            {
                @Override
                public void onClick(Player player)
                {
        ...
        {
            items.add(new Item(22, new ItemStack(Material.RED_STAINED_GLASS_PANE, 1, DyeColor.RED.getDyeData()), "Similar txt actions", "Click to enable", new Item.ClickAction()
            {
                @Override
                public void onClick(Player player)
                {
        ...
        {
            items.add(new Item(25, new ItemStack(Material.GREEN_STAINED_GLASS_PANE, 1, DyeColor.GREEN.getDyeData()), "URL actions", "Click to disable", new Item.ClickAction()
            {
                @Override
                public void onClick(Player player)
                {
        ...
        {
            items.add(new Item(25, new ItemStack(Material.RED_STAINED_GLASS_PANE, 1, DyeColor.RED.getDyeData()), "URL actions", "Click to enable", new Item.ClickAction()
            {
                @Override
                public void onClick(Player player)
                {
        ...
        {
            items.add(new Item(26, new ItemStack(Material.GREEN_STAINED_GLASS_PANE, 1, DyeColor.GREEN.getDyeData()), "Blacklist actions", "Click to disable", new Item.ClickAction()
            {
                @Override
                public void onClick(Player player)
                {
        ...
        {
            items.add(new Item(26, new ItemStack(Material.RED_STAINED_GLASS_PANE, 1, DyeColor.RED.getDyeData()), "Blacklist actions", "Click to enable", new Item.ClickAction()
            {
                @Override
                public void onClick(Player player)
                {
